...
let templates = {
    "Auto & Transport": [
        ()=> { return `${randomNumberWith(10)} UBER TRIP ${faker.random.alphaNumeric(faker.random.number(minChars(7)))}`},
    ],
    "Food & Dining": [
        ()=> { return `${randomNumberWith(10)}8284120518LOAC720417H51CAFE DAS CORTEZ I`},
        ()=> { return `${randomNumberWith(10)}CCO 8605231N4OXXO ${faker.random.alphaNumeric(faker.random.number(minChars(12)))}`},
        ...
        ()=> { return `${randomNumberWith(10)}LGR 150220P98CAFE BARISTI ${faker.random.alphaNumeric(faker.random.number(minChars(4)))}`},
        ()=> { return `${randomNumberWith(10)}MAP 170314HN4EL MUCHACHO ALEGR`},
        ()=> { return `${randomNumberWith(10)}MARP8505084H5LA FLOR DE OAXACA`},
        ()=> { return `${randomNumberWith(10)}OCA 131120R10SUBWAY ${faker.random.alphaNumeric(faker.random.number(minChars(6)))}`},
    ...
    "Health & Fitness": [
        ...
        ()=> { return `${randomNumberWith(10)}CFC 110121742F AHORRO ${faker.random.alphaNumeric(faker.random.number(minChars(8)))}`},
    ...
    "Shopping": [
        ()=> { return `${randomNumberWith(10)}CDE 8401046V6CALIMAX ${faker.random.alphaNumeric(faker.random.number(minChars(9)))}`},
        ()=> { return `${randomNumberWith(10)}NWM 9709244W4SUPERCENTER TIJUA`},
        ()=> { return `${randomNumberWith(23)}AMZ Mechanica US`},
    ],
    "Entertainment": [
        ()=> { return `${randomNumberWith(10)}CME 981208VE4CINEPOLIS ${faker.random.alphaNumeric(faker.random.number(minChars(7)))}`},
    ],
    "Bills & Utilities": [
        ()=> { return `${randomNumberWith(2)} COMPRA T AIRE ${randomNumberWith(minChars(10))} EN BPI`},
    ],
    "Fees & Charges": [
        ()=> { return `70COMISION RETIRO INTERNACIONAL${randomNumberWith(minChars(8))}`},
    ],
    "Auto & Transport": [
        ()=> { return `${randomNumberWith(23)}UBER TRIP ${faker.random.alphaNumeric(Math.min(faker.random.number(minChars(7))))}`},
